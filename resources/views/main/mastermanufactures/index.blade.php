                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="modalNewIncomingLabel">Add New Manufactures</h5>
                        ...
                        <div class="modal-body">
                          <div class="mb-3">
                            <label for="manufacture_name" class="form-label">Manufactures Name</label>
...
tabindex="-1" aria-labelledby="modalEditSourcesLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditSourcesLabel">Edit Manufactures</h5>
                    <button type="button" class="btn-close"
                        data-bs-dismiss="modal" aria-label="btn-close"></button>
            </div>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="edit_manufacture_name" class="form-label">Manufactures Name</label>
